package com.shimu.mes.base.models;
...
import com.shimu.mes.base.commons.CommonConstant;
<#if data.hasEnum>
...
<#list data.allColumn as column>
    ...
    */
    ...
    <#if column.javaFieldName == "updateDepartmentId">
        @TableField(fill = FieldFill.UPDATE)
    </#if>
    <#if column.javaFieldName == "updateDepartmentName">
        @TableField(fill = FieldFill.UPDATE)
    </#if>
    ...
    <#if column.javaFieldName == "insertDepartmentId">
        @TableField(fill = FieldFill.INSERT)
    </#if>
    <#if column.javaFieldName == "insertDepartmentName">
        @TableField(fill = FieldFill.INSERT)
    </#if>
