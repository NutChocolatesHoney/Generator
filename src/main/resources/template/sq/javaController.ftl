package com.sq.controllers;

import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.sq.commons.ApiResultHelper;
import com.sq.entities.request.Edit${data.classNameWithOutPrefix}Req;
import com.sq.entities.response.${data.classNameWithOutPrefix}Resp;
import com.sq.entities.condition.${data.className}Condition;
import com.sq.models.${data.className};
import com.sq.services.${data.className}Service;
import com.sq.interfaces.Add;
